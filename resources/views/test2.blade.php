        ...
        <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
          <div class="container mx-auto px-4 py-2">
            <div class="mb-5 w-auto">
              ...
              <div class="relative">
                <input type="hidden" name="date" x-ref="date" :value="datepickerValue" class="bg-white dark:bg-gray-900" />
                <input type="text" x-on:click="showDatepicker = !showDatepicker" x-model="datepickerValue" x-on:keydown.escape="showDatepicker = false" class="w-full pl-4 pr-10 py-3 leading-none rounded-lg shadow-sm focus:outline-none
                 text-gray-600 font-medium   bg-white dark:bg-gray-900" placeholder="Select date" readonly />
                ...
                <div class="bg-white dark:bg-gray-900 mt-12 rounded-lg shadow p-4 absolute top-2 left-0" style="width: 17rem" x-show.transition="showDatepicker" @click.away="showDatepicker = false">
