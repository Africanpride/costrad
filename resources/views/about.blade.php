<x-main-layout>
    ...
    <div class="max-w-[85rem] md:h-[80vh] flex flex-col justify-center  px-4 sm:px-6 lg:px-8 dark:bg-black">
        <div>
            <!-- Page Heading -->
            <div class="max-w-3xl space-y-2 md:space-y-4 py-8">
                ...
                <p class="mt-2 text-lg text-gray-800 dark:text-gray-400">The College of Sustainable Transformation and
                ...
                <p class="mt-2 text-lg text-gray-800 dark:text-gray-400">These sustainable transformation educational
            ...
            <div class="mt-5 sm:mt-10 lg:mt-0">
                <div class="space-y-6 sm:space-y-8">
                    ...
                    <div class="space-y-2 md:space-y-4">
                        ...
                        <h2
                            class="uppercase font-['anton'] text-3xl lg:text-4xl text-gray-700 dark:text-firefly-700">
