<x-main-layout>
    ...
    <div class="max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 dark:bg-black">
        <!-- Page Heading -->
        <div class="max-w-3xl">
            <p class="mb-2 text-sm font-semibold text-blue-600">Starter Pages &amp; Examples</p>
            <h1 class="block text-2xl font-bold text-gray-800 sm:text-3xl dark:text-white">Sticky Header using
                Tailwind CSS</h1>
