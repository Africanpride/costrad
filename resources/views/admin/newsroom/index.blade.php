                            ...
                            <div
                                ...
                                {{-- <div
                                                    ...
                                                    <time datetime="2022-10-10"
                                                        ...
                                                        <span>{{ \Carbon\Carbon::parse($news->u)->format('M jS') }}</span>
                                                        <span class="w-px flex-1 bg-gray-900/50 dark:bg-white/10"></span>
                                                        <span>{{ \Carbon\Carbon::parse($news->endDate)->format('M jS') }}</span>
                                                    </time>
                                                </div> --}}
                                ...
                                <div class="">
                                    <div class="flex justify-start items-center">
                                        ...
                                        <a rel="noopener noreferrer" href="{{ route('newsroom.show', [$news->slug]) }}"
                                            ...
                                            <span
                                                ...
                                                <span>Visit <span class="uppercase">{{ $news->slug }}</span></span>
