<div id="dismiss-alert" class="hs-removing:easeOut hs-removing:opacity-0 transition duration-500 relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 dark:bg-black py-2.5 px-6 sm:px-3.5 sm:before:flex-1">
    ...
    <div class="flex flex-wrap items-center gap-y-2 gap-x-4">
      ...
      <a href="#" class="flex gap-1 justify-center items-center rounded-full bg-gray-900 py-1 px-2.5 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900"><span>About FDI</span> <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="flex flex-1 justify-end">
      <button type="button" class="-m-3 p-3 focus-visible:outline-offset-[-4px]" data-hs-remove-element="#dismiss-alert">
