<div>
    <div id="add-new-role"
        ...
        <div
            ...
            <div
                class="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                ...
                <div class="p-4 sm:p-10 overflow-y-auto">
                    ...
                    <form wire:submit.prevent="submit">
                        <div class="space-y-4">
                            ...
                            <input wire:model="role" id="role" type="text"
                ...
                <div
                    ...
                    <button type="submit" class="py-2.5 px-4 inline-flex w-full justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800"
                        href="#">
