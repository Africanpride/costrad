<x-app-layout>
    <x-admin.pageheader model-name="{{ __('appointment Types') }}" description="Maintain <br /> appointments Types"
        ...
        <div class="p-4 space-y-3">
            ...
            <div class="p-6 shadow rounded-lg bg-firefly-50 dark:bg-slate-900 dark:text-white hidden">
                ...
                <div class="space-y-3">
                    <p class="max-w-7xl">
                        {{ __('In a hospital setting, a appointment is usually referred to as a "procedure" or "medical intervention." The exact terminology may vary depending on the context and the specific type of appointment being performed. For example, a surgical procedure may be referred to as an "operation," while a diagnostic test may be referred to as an "examination".') }}


                    <div class="gap-4 grid grid-cols-1 md:flex justify-start items-center">
                        <x-admin.generic-button onclick="Livewire.emit('openModal', 'admin.appointment.add-appointment')">
                ...
                {{-- <livewire:admin.available-appointments /> --}}
                {{-- <hr class="my-6 dark:border-gray-600 border-firefly-200" />
            ...
            <div class="p-2  ">
                <div class="flex justify-end items-center">
                    ...
                    <x-admin.generic-button onclick="Livewire.emit('openModal', 'admin.appointment.add-appointment')">
                        <span class="flex items-center justify-center gap-2">
                            <x-lucide-alarm-clock class="w-6 h-6 text-yellow-500 " />
                            {{ __('Add New appointment') }}
                        </span>
                    </x-admin.generic-button>
                </div>
                                ...
                                <thead>
                                    <tr
                                        ...
                                        <th scope="col"
                                            ...
                                            <span class="lg:pl-2">appointment Details</span>
                                        </th>
                                        <th scope="col"
                                            class="px-6 py-3 text-left text-xs leading-4 font-medium  uppercase tracking-wider dark:text-secondary-400">
                                            Description
                                        ...
                                        <tr>
                                                ...
                                                <div class="flex items-center">
                                                    <div class="shrink-0 h-10 w-10">
                                                        <img class="h-10 w-10 rounded-full"
                                                            src="https://ui-avatars.com/api/?name={{ $appointment->name }}&amp;color=1d4ed8&amp;background=dbeafe"
                                                            alt="User avatar">
                                                    </div>
                                                    <div class="ml-4">
                                                        ...
                                                        <div
                                                            ...
                                                            <time datetime="{{ Auth::user()->created_at }}"
                                                                class="capitalize">{{ $appointment->created_at->diffForHumans() }}
                                                            </time>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <td
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    </svg> <span class="ml-1.5">{{ $appointment->description }}</span>
                                                </div>
                                            </td>
                                            <td
                                            ...
                                            <td
                                                ...
                                                <div class="w-full flex items-center justify-between gap-2">
                                                    <x-lucide-check-circle-2
                                                        class="{{ $appointment->active ? 'text-green-500' : 'text-red-500' }}
                                                w-5 h-5 duration-500" />
                                                    <span>

                                                        <div class="hs-tooltip flex items-center">
                                                            <input wire:click="toggleActive({{ $appointment->id }})" type="checkbox"
