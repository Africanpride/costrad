...
<div>
    ...
    <div class="max-w-2xl">
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="flex w-full sm:items-center gap-x-5 sm:gap-x-3">
                <div class="flex-shrink-0">
                    <img  wire:click="increment" class="h-12 w-12 rounded-full cursor-pointer " src="{{ $newsroom->author?->profile_photo_url }}"
        ...
        <div class="space-y-5 md:space-y-8">
            ...
            <p class="text-lg text-gray-800 dark:text-gray-200">As we've grown, we've seen how Preline has helped
            ...
            <ul class="list-disc list-outside space-y-5 pl-5 text-lg text-gray-800 dark:text-gray-200">
                <li class="pl-2">Preline allows us to collaborate in real time and is a really great way for
                ...
                <li class="pl-2">Preline opened a new way of sharing. It's a persistent way for everyone to see and
            ...
            <p class="text-lg text-gray-800 dark:text-gray-200">Small teams and individual designers need a space where
