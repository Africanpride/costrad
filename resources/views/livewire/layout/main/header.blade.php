...
<nav class="max-w-[85rem] flex flex-wrap basis-full items-center w-full mx-auto px-4 sm:px-6 lg:px-8 py-3"
    ...
    <div id="docs-navbar"
        ...
        style="">
        <div class="flex flex-col gap-6 mb-5 md:mb-0 md:flex-row md:items-center md:justify-end md:mt-0 md:pl-5 mt-5">
            ...
            <a href="/about"
                class="inline-flex items-center gap-x-3 text-black font-medium hover:text-gray-600 transition dark:text-gray-200 dark:hover:text-gray-400 active-link text-blue-500 hover:text-blue-500 dark:text-blue-500 dark:hover:text-blue-500"
                href="./examples.html">
                <svg class="block w-4 h-4 md:hidden" xmlns="http://www.w3.org/2000/svg" width="16"
                    height="16" fill="currentColor" viewBox="0 0 16 16">
                    <path
            ...
            <div
                ...
                <button type="button"
                    ...
                    <svg class="block w-4 h-4 md:hidden mr-3 " xmlns="http://www.w3.org/2000/svg"
