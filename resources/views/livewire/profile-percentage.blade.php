<!-- Announcement Banner -->
<div x-data="{ showBanner: {{ ($this->calculateProfileCompletionPercentage(Auth::user()?->profile->id) < 80 )}} }" x-show="showBanner"
    ...
    <div
        ...
        <div class=" inline-block text-sm text-gray-800 dark:text-gray-200">
            <div>
                Profile Details Incomplete. Kindly Complete your profile to enable us serve you better.
                <span
