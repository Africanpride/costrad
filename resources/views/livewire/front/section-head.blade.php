                ...
                <div class="mx-auto mb-[60px] max-w-[920px] text-center lg:mb-20 space-y-3">
                    <div class="inline-block">
                        <div class="card-top-text">
                            ...
                            <svg class="text-current w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<line x1="8" y1="12" x2="16" y2="12"></line>
                    ...
                    <p class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed">
                        Get answers to your questions anytime, anywhere about <a href="http://localhost:8000/costrad" class=" bg-clip-text bg-gradient-to-l from-firefly-600 to-violet-500 text-transparent dark:from-firefly-400 dark:to-violet-400">COSTrAD</a>.
        ...
        <div class="max-w-[85rem] px-4 py-5 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div class="max-w-full mx-auto">
                ...
                <div class="hs-accordion-group grid grid-cols-2 gap-4">
                    ...
                    <div class="border border-gray-500/20  hover:shadow-md transition hs-accordion hs-accordion-active:bg-gray-100 rounded-xl p-6 dark:hs-accordion-active:bg-white/[.05] active" id="hs-basic-with-title-and-arrow-stretched-heading-one">
                    ...
                    <div class="border border-gray-500/20  hover:shadow-md transition hs-accordion hs-accordion-active:bg-gray-100 rounded-xl p-6 dark:hs-accordion-active:bg-white/[.05]" id="hs-basic-with-title-and-arrow-stretched-heading-two">
                    ...
                    <div class="border border-gray-500/20  hover:shadow-md transition hs-accordion hs-accordion-active:bg-gray-100 rounded-xl p-6 dark:hs-accordion-active:bg-white/[.05]" id="hs-basic-with-title-and-arrow-stretched-heading-three">
                    ...
                    <div class="border border-gray-500/20  hover:shadow-md transition hs-accordion hs-accordion-active:bg-gray-100 rounded-xl p-6 dark:hs-accordion-active:bg-white/[.05]" id="hs-basic-with-title-and-arrow-stretched-heading-four">
                    ...
                    <div class="border border-gray-500/20  hover:shadow-md transition hs-accordion hs-accordion-active:bg-gray-100 rounded-xl p-6 dark:hs-accordion-active:bg-white/[.05]" id="hs-basic-with-title-and-arrow-stretched-heading-five">
                    ...
                    <div class="border border-gray-500/20  hover:shadow-md transition hs-accordion hs-accordion-active:bg-gray-100 rounded-xl p-6 dark:hs-accordion-active:bg-white/[.05]" id="hs-basic-with-title-and-arrow-stretched-heading-six">
