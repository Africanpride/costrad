        ...
        <div class="grid gap-6 row-gap-10 lg:grid-cols-2">
            <div class="lg:py-6 lg:pr-16">
                <div class="flex">
                    ...
                    <div class="pt-1 pb-8">
                        ...
                        <p class="text-gray-700 dark:text-gray-300 ">
                            Registration is the first step in harnessing what we have to offer.
                        </p>
                    </div>
                </div>
                <div class="flex">
                    ...
                    <div class="pt-1 pb-8">
                        ...
                        <p class="text-gray-700 dark:text-gray-300 ">
                            After registration, take the opportunity to complete your profile. Completing your profile
                            is a one-time This enable us to adequately prepare for your arrival and to give you the
                ...
                <div class="flex">
                    ...
                    <div class="pt-1 pb-8">
                        <p class="mb-2 text-lg font-bold">Step 4: Approval & Payment </p>
                        <p class="text-gray-700 dark:text-gray-300 ">
                            Upon approval of your application, you are encouraged to pay to reserve your seat.
                        </p>
                    </div>
                </div>
                <div class="flex">
            ...
            <div class="relative">
                <img class="inset-0 object-cover object-bottom w-full shadow-lg h-96 lg:absolute lg:h-full rounded-xl"
