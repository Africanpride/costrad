<x-front-layout>
    ...
    <div class="relative overflow-hidden">
        <div class="max-w-[85rem] px-4 py-12 sm:px-6 md:px-8 md:py-16 mx-auto">
            ...
            <!-- Grid -->
            <div class="md:grid md:grid-cols-6 md:gap-8 md:items-center">
                <div class="hidden md:block md:col-span-2">
                    <img class="rounded-xl" src="{{ asset('images/main/cheque_.jpg') }}" alt="Image Description">
                </div>
                <!-- End Col -->
                ...
                <div class="md:col-span-4 h-auto ">
                    <!-- Blockquote -->
                    <blockquote>
                        <div class="flex justify-start items-center gap-x-2 h-10 text-3xl pb-6">
                            <img class="w-12" src="{{ asset('images/main/cheque2.png') }}"
                                alt="Donate to costrad via cheque">
                            <span class="pt-2">Donate Via Mail</span>
                        </div>

                        <p
                            class="text-xl font-medium text-gray-800 md:text-xl md:leading-normal tracking-tight dark:text-gray-200">
                            For your donations via cheque, mail to "<span
                                class="font-bold  text-gray-900 dark:text-gray-50 text-gradient__teal">P.O Box CT 4467
                                Cantonments, Accra; Greater Accra Region, Ghana</span>" , with "College of Sustainable
                            Transformation And Development" As Payee. Thanks you in advance for your Kind donation.
                        </p>

                        <footer class="my-6 pb-6 flex justify-start items-center gap-x-16">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 md:ml-0">
                                    ...
                                    <p class="text-sm">
                                        <span class="  prominent-titles">P.O Box CT 4467 <br />Cantonments, Accra,
                                            Ghana.
                                        </span>
                                    </p>
                                </div>
                            ...
                            <div class="flex items-center">
                                <div class="md:hidden flex-shrink-0">
                                    <img class="h-16 w-16 rounded-full"
                                        src="https://images.unsplash.com/photo-1671726203390-cdc4354ee2eb?ixlib=rb-4.0.3&ixid=KkV-GYUCZf4&auto=format&fit=facearea&facepad=2&w=320&h=320&q=80"
                                        alt="Image Description">
                                </div>
                                <div class="ml-4 md:ml-0">
                                    ...
                                    <p class="text-sm">
                                        <span class="  prominent-titles">College of Sustainable Transformation<br />
                                            And Development.
                                        </span>
                                    </p>
                                </div>
