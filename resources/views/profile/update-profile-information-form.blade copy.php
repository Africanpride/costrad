<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{ photoName: null, photoPreview: null }" class="col-span-6 sm:col-span-4 space-y-5">
                <div class="grid grid-cols-3 gap-4 place-items-start items-center ">
      ...
      " />
                    ...
                    <div class="col-span-2 bg-yellow-500">
        ...
        <div class="col-span-6 sm:col-span-4 space-y-6">
            <div class="grid md:gap-x-2 md:grid-cols-2">
