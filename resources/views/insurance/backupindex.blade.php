<x-app-layout>
    <x-admin.pageheader model-name="Insurance" description="Maintain <br /> Insurance" add-button="false" class="mx-4">
        ...
        <div class="p-4 space-y-4">
            ...
            <div class="flex justify-start items-center relative"  x-data="scrollProgress">
                <svg height="50" width="50" >

                    <circle cx="25" cy="25" r="10"  stroke="currentColor" stroke-width="3"
                        fill="transparent" class="text-gray-300" />

                    <circle  stroke-width="5" :stroke-dasharray="circumference"
                        :stroke-dashoffset="circumference - percent / 100 * circumference" stroke-linecap="round"
                        stroke="currentColor" fill="transparent" class="text-firefly-500" cx="25" cy="25" r="10" />
                </svg>
                <div class="text-secondary-400">123</div>
            </div>

            <div x-data="scrollProgress" class="">
