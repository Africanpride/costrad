<x-app-layout>
 ...
 text-secondary-900  dark:text-secondary-400 uppercase ">
                                ...
                                <th
                                    ...
                                    Address</th>
                                <th class="font-normal py-2  border-b border-gray-200 dark:border-gray-800">Coverage ( %
                                    )</th>
                                <th
                                    class="font-normal py-2  border-b border-gray-200 dark:border-gray-800 hidden md:table-cell">
                                    Telephone</th>
                                ...
                                <tr>
                                    ...
                                    <td class=" py-2 pr-2  border-b border-gray-200 dark:border-gray-800 ">
                                        <div class="flex justify-start items-center gap-2" x-data="scrollProgress">
                                            ...
                                            <div
                                                class="overflow-hidden h-2 text-xs flex rounded bg-firefly-200 w-[100%]">
                                            ...
                                            <div class=" text-sm text-secondary-400 "
                                                x-text="` {{ $insurance->percentage }}%`"></div>
                                        </div>
                                    </td>
                                    <td
            ...
            @else
                <div
                    class=" my-5 min-h-[15rem] flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                    <div class="flex flex-auto flex-col justify-center items-center p-4 md:p-5">
                        <svg class="max-w-[5rem]" viewBox="0 0 375 428" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path d="M254.509 253.872L226.509 226.872" class="stroke-gray-400 dark:stroke-white"
                            ...
                            <path
                                ...
                                class="stroke-gray-400 dark:stroke-white" stroke="currentColor" stroke-width="7"
                                stroke-linecap="round" />
                            <rect x="270.524" y="221.872" width="137.404" height="73.2425" rx="36.6212"
                                transform="rotate(40.8596 270.524 221.872)" class="fill-gray-400 dark:fill-white"
                                fill="currentColor" />
