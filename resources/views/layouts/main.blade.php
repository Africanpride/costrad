...
<body
    class="bg-white dark:bg-slate-900 min-h-[75rem] scrollbar-thin
scrollbar-thumb-firefly-800 dark:scrollbar-thumb-firefly-900 scrollbar-track-gray-300 overflow-y-scroll overflow-x-hidden">
    ...
    <!-- ========== HEADER ========== -->
    <header
        class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm py-4 bg-white/[.8] md:bg-transparent backdrop-blur-md md:backdrop-blur-none dark:bg-slate-900 ">
        <nav class="max-w-[85rem] flex flex-wrap basis-full items-center w-full mx-auto px-4 sm:px-6 lg:px-8"
            ...
            <div id="docs-navbar"
                ...
                style="">
                <div class="flex flex-col gap-6 mt-5 md:flex-row md:items-center md:justify-end md:mt-0 md:pl-5">
                    ...
                    <a class="inline-flex items-center gap-x-3 text-black font-medium hover:text-gray-600 transition dark:text-gray-200 dark:hover:text-gray-400 active-link text-blue-500 hover:text-blue-500 dark:text-blue-500 dark:hover:text-blue-500"
                        href="./examples.html">
                        <svg class="block w-4 h-4 md:hidden" xmlns="http://www.w3.org/2000/svg" width="16"
                            height="16" fill="currentColor" viewBox="0 0 16 16">
                            <path
                    ...
                    <div class="hs-dropdown [--strategy:static] md:[--strategy:absolute] [--adaptive:none] md:[--trigger:hover] py-3 md:py-4">
                        ...
                        <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-full hidden z-10 top-full right-0 md:w-[900px] min-w-[15rem] bg-white md:shadow-2xl md:px-4 dark:bg-gray-800 dark:divide-gray-700 before:absolute before:-top-5 before:left-0 before:w-full before:h-5">
                          <div class="md:grid md:grid-cols-2 lg:grid-cols-3 gap-x-2">
                            ...
                            <div class="aspect-w-16 aspect-h-9 md:relative">
                                <img class="w-full object-cover md:absolute h-full" src="https://images.unsplash.com/photo-1661956602116-aa6865609028?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1064&q=80" alt="Image Description">
                              </div>
                    ...
                    <a class="inline-flex items-center gap-x-3 text-black font-medium hover:text-gray-600 transition dark:text-gray-200 dark:hover:text-gray-400 "
                        ...
                        Figma <span
                            class="inline bg-blue-50 border border-blue-300 text-blue-600 text-[.6125rem] leading-4 uppercase rounded-full py-0.5 px-2 dark:bg-blue-900/[.75] dark:border-blue-700 dark:text-blue-500">New</span>
                    </a>
                </div>
            </div>
        </nav>
